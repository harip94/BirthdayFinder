...
class ViewController: UIViewController {
  ...
  @IBAction func FindBday(_ sender: AnyObject) {
    performSegue(withIdentifier: "idSegueFindBday", sender: self)
  }
  ...
  /// Set ViewController class as the delegate of the FindBdayViewControllerDelegate protocol
  override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
    if let identifier = segue.identifier {
      if identifier == "idSegueFindBday" {
        let FindBdayViewController = segue.destination as! FindBdayViewController
        FindBdayViewController.delegate = self
      }
    }
  }
}
...
extension ViewController: FindBdayViewControllerDelegate {
